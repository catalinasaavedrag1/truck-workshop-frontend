      ...
      render: (item) => {
        ...
        return (
          <div className={styles.incidentIdentity}>
            ...
            <span>{driver?.name || 'Sin chofer asociado'}</span>
          </div>
        )
      },
      ...
      render: (item) => {
        ...
        return (
          <div className={styles.chipLine}>
            {freight ? <span className="muted-text">{freight.requestNumber}</span> : null}
            {workshopCase ? <span className="muted-text">{workshopCase.caseNumber}</span> : null}
