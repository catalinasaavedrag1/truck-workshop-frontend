          ...
          <div className={styles.detailStack}>
            <Card className={styles.heroCard}>
              ...
              <div className={styles.contextList}>
                <ContextItem label="Camion" value={truck ? `${truck.plate} / ${truck.brand} ${truck.model}` : incident.truckId} />
                <ContextItem label="Chofer" value={driver?.name || incident.driverId || 'Sin chofer'} />
                <ContextItem label="Flete" value={freight ? `${freight.requestNumber} / ${freight.customerName}` : 'No vinculado'} />
                <ContextItem label="Caso taller" value={workshopCase?.caseNumber || 'No derivado'} />
