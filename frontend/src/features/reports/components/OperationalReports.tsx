...
export function TechnicalInspectionExpirationReport({
  ...
  const columns: TableColumn<TechnicalInspectionExpirationRow>[] = [
    ...
    },
    {
      ...
      render: (item) =>
        item.documentId ? (
          <EntityLink id={item.documentId} type="truckDocument" variant="subtle">
            {item.documentNumber || item.documentId}
          </EntityLink>
        ) : (
          item.documentNumber || 'No cargado'
        ),
    },
  ]
      ...
      render: (item) => (
        <div className="stack-tight">
          ...
          <span className="muted-text">
            <EntityLink id={item.freightId} type="freightRequest" variant="subtle">
              {item.freightId}
            </EntityLink>
            {' · '}
            {item.truckPlate}
  ...
  const columns: TableColumn<DriverTripSheetPerformanceRow>[] = [
    {
      ...
      render: (item) => (
        <div className="stack-tight">
          <EntityLink id={item.driverId} type="driver">
            {item.driverName}
          </EntityLink>
