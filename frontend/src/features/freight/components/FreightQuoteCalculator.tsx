...
import { freightQuotesMock } from '../mocks/freight.mock'
import {
...
export function FreightQuoteCalculator({ request }: FreightQuoteCalculatorProps) {
  ...
  const selectedCustomer = customers.find((customer) =>
    request?.customerId ? customer.id === request.customerId : customer.name === request?.customerName,
  )
  const quoteReferences: CustomerCreditQuoteReference[] = freightQuotes.map((quote) => ({
      ...
      <div className="stack">
        ...
        {request ? (
          <CustomerCreditDecisionPanel
            ...
            quoteTotal={activeCalculation.total}
