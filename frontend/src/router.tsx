...
const ClientFreightRequestPage = lazyPage(
  () => import('./features/freight/pages/ClientFreightPortalPages'),
  'ClientFreightRequestPage',
)
const ClientFreightRequestsPage = lazyPage(
  () => import('./features/freight/pages/ClientFreightPortalPages'),
  'ClientFreightRequestsPage',
)
const ClientFreightHistoryPage = lazyPage(
  () => import('./features/freight/pages/ClientFreightPortalPages'),
  'ClientFreightHistoryPage',
)
const ClientFreightTrackingPage = lazyPage(
  () => import('./features/freight/pages/ClientFreightPortalPages'),
  'ClientFreightTrackingPage',
)
...
const routes = [
  ...
  },
  {
    children: [
      ...
      { element: routeElement(<ClientFreightRequestPage />), path: ROUTES.freightClientPortal },
      { element: routeElement(<ClientFreightRequestsPage />), path: ROUTES.freightClientPortalRequests },
      { element: routeElement(<ClientFreightHistoryPage />), path: ROUTES.freightClientPortalHistory },
      { element: routeElement(<ClientFreightTrackingPage />), path: ROUTES.freightClientPortalTracking() },
